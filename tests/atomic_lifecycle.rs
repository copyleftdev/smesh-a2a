...
#[tokio::test]
#[allow(clippy::too_many_lines)] // Keep the complete v1-to-v9 migration fixture auditable together.
async fn exact_v1_schema_migrates_to_v9_with_explicit_binding_preserving_keys_and_task() {
