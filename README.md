...
- Deterministic organization-runtime LIFELINE outage scenario with joined cancellation,
  one linked fallback, sibling continuity, and bounded restricted JSONL replay evidence
