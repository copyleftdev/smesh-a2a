...
pub mod error_code {
    ...
    pub const QUOTA_EXCEEDED: i32 = -32010;
    pub const QUOTA_AUTHORITY_UNAVAILABLE: i32 = -32011;
...
pub fn error_reason(code: i32) -> &'static str {
    match code {
        ...
        error_code::QUOTA_EXCEEDED => "RESOURCE_EXHAUSTED",
        error_code::QUOTA_AUTHORITY_UNAVAILABLE => "UNAVAILABLE",
...
pub fn reason_to_error_code(reason: &str) -> Option<i32> {
    match reason {
        ...
        "RESOURCE_EXHAUSTED" => Some(error_code::QUOTA_EXCEEDED),
        "UNAVAILABLE" => Some(error_code::QUOTA_AUTHORITY_UNAVAILABLE),
...
impl A2AError {
    ...
    pub fn http_status_code(&self) -> u16 {
        match self.code {
            ...
            error_code::QUOTA_EXCEEDED => 429,
            error_code::QUOTA_AUTHORITY_UNAVAILABLE => 503,
